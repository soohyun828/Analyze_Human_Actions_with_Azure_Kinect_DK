...
int main()
{
    ...
    if (k4a_playback_open("output.mkv", &playback_handle) != K4A_RESULT_SUCCEEDED)
    {
    ...
    k4a_stream_result_t stream_result = k4a_playback_get_next_capture(playback_handle, &capture);
